...
const Hero = () => {
  return (
    <div className="relative h-screen w-full bg-skypearl-dark overflow-hidden">
      <div 
        className="absolute inset-0 bg-gradient-to-r from-skypearl-dark/90 to-skypearl-dark/60"
        style={{
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-r from-skypearl-dark/80 to-transparent" />
