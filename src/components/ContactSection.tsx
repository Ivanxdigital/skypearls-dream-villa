  ...
  return (
    <section id="contact" className="section-padding bg-skypearl-dark text-white relative overflow-hidden">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/70">info@skypearlsvillas.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/70">+63 (918) 123-4567</p>
                    </div>
                  </div>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <a 
          href="https://wa.me/639181234567" 
          target="_blank" 
          rel="noreferrer" 
          className="flex items-center gap-2 bg-[#25D366] text-white px-4 py-3 rounded-full shadow-lg hover:bg-opacity-90 transition-colors"
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
